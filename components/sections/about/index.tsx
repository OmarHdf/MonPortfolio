    ...
    >
      ...
      <div className="flex gap-9 items-center flex-col w-10/12 mx-auto p-5 rounded-lg container">
        ...
        <div className="space-y-4 text-center lg:text-left">
          ...
          >
            I&apos;m <strong>Omar El Hedfi</strong> — I build secure, scalable web
            solutions and automate the pipelines behind them.
            <br />
            <br />I work full-stack, DevSecOps, and fast. Mostly with{' '}
            <strong>Next.js, React, TypeScript, Docker, Kubernetes, Jenkins</strong>, and
            whatever else it takes to deliver production-ready solutions.
            <br />
            <br />
            Some teams hire me to build from scratch. Others bring me in when{' '}
            <strong>
              CI/CD pipelines fail, deployments break, security scans explode, or apps
            ...
            <br />✅ <strong>Build Secure Pipelines</strong> – CI/CD with Jenkins,
            Trivy, SonarQube, Hadolint, Dockle.
            <br />✅ <strong>DevSecOps Automation</strong> – Docker/Kubernetes
            deployments, GitHub Actions, security-first workflows.
            <br />✅ <strong>AI Integration</strong> – LLaMA, Gemini, OpenAI features
            like auto-report summaries and smart chat.
            <br />✅ <strong>Full Stack Development</strong> – Next.js, React,
            TypeScript, REST APIs.
            <br />✅ <strong>Performance Optimization</strong> – Faster builds,
            scalable infrastructure, clean architecture.
            <br />
            <br />
            <span className="font-semibold">📌 Why Work With Me?</span>
            <br />
            🔹 I combine development with <strong>security and automation</strong> — your
            apps run fast, scale safely, and pass audits.
            <br />
            🔹 I work efficiently — no endless loops, just working solutions.
            <br />
            🔹 I prevent future issues — everything is built to be{' '}
            <strong>maintainable and future-proof</strong>.
            <br />
            <br />
            <span className="font-semibold">📌 Let&apos;s Talk</span>
            <br />
            If you need <strong>a secure pipeline, a scalable app, or AI-driven
            features</strong>, let&apos;s connect.
            <br />
